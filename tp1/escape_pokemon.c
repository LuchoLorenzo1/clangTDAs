...
int main(int argc, char *argv[])
{
	...
	printf("Objetos...\n");
        ...
        bool interaccion1 = sala_es_interaccion_valida(sala, "examinar", "habitacion", VACIO);
        bool interaccion2 = sala_es_interaccion_valida(sala, "abrir", "pokebola", VACIO);
        bool interaccion3 = sala_es_interaccion_valida(sala, "usar", "llave", "cajon");
        bool interaccion4 = sala_es_interaccion_valida(sala, "qumar", "mesa", VACIO);
