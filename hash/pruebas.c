...
void pruebas_quitar()
{
	...
	hash_t *diccionario_scaloneta = hash_crear(5);
	if (!diccionario_scaloneta)
		return;

	int a = 1, b = 2, c = 3, d = 4, e = 5, f = 6, g = 7;
	hash_insertar(diccionario_scaloneta, "Messi", &a, NULL);
	hash_insertar(diccionario_scaloneta, "Fideo Di maria", &b, NULL);
	hash_insertar(diccionario_scaloneta, "De paul", &c, NULL);
	hash_insertar(diccionario_scaloneta, "Paredes", &d, NULL);

	int *quitado = hash_quitar(diccionario_scaloneta, "Fideo Di maria");
	pa2m_afirmar(*quitado == b,
		     "Quitar un elemento devuelve el elemento quitado");
	pa2m_afirmar(
		hash_contiene(diccionario_scaloneta, "Fideo Di maria") == false,
		"Quitar un elemento y despues ver si el hash lo contiene devuelve false");
	pa2m_afirmar(hash_obtener(diccionario_scaloneta, "Fideo Di maria") ==
			     NULL,
		     "Quitar un elemento y despues buscarlo devuelve NULL");
	pa2m_afirmar(
		hash_cantidad(diccionario_scaloneta) == 3,
		"Quitar un elemento reduce la cantidad del hash correctamente");

	quitado = hash_quitar(diccionario_scaloneta, "Messi");
	pa2m_afirmar(*quitado == a,
		     "Quitar un elemento devuelve el elemento quitado");
	quitado = hash_quitar(diccionario_scaloneta, "De paul");
	pa2m_afirmar(*quitado == c,
		     "Quitar un elemento devuelve el elemento quitado");
	quitado = hash_quitar(diccionario_scaloneta, "Paredes");
	...
	pa2m_afirmar(
		hash_contiene(diccionario_scaloneta, "Messi") == false,
	...
	hash_insertar(diccionario_scaloneta, "De paul", &c, NULL);
	hash_insertar(diccionario_scaloneta, "Paredes", &d, NULL);
	hash_insertar(diccionario_scaloneta, "Guido rodriguez", &e, NULL);
	hash_insertar(diccionario_scaloneta, "lautaro martinez", &f, NULL);
	hash_insertar(diccionario_scaloneta, "otamendi", &g, NULL);
	...
	pa2m_afirmar(
		hash_cantidad(diccionario_scaloneta) == 6,
	...
	hash_quitar(diccionario_scaloneta, "Fideo Di maria");
	hash_quitar(diccionario_scaloneta, "Guido rodriguez");
	hash_quitar(diccionario_scaloneta, "lautaro martinez");
	hash_quitar(diccionario_scaloneta, "otamendi");

	pa2m_afirmar(
		hash_cantidad(diccionario_scaloneta) == 0,
		"Vaciar el hash despues de haber sobrepasado la capacidad inicial, hace que la cantidad del hash sea 0");
	pa2m_afirmar(
		hash_contiene(diccionario_scaloneta, "otamendi") == false,
		"Ver si el hash contiene un elemento en un hash vacio devuelve false");
	pa2m_afirmar(hash_obtener(diccionario_scaloneta, "otamendi") == NULL,
